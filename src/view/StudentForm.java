...
public class StudentForm extends javax.swing.JFrame {
    ...
    private void jTableStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableStudentMouseClicked
        ...
        if (selecttedRow != -1) {
            ...
            this.nimLama = jTableStudent.getValueAt(selecttedRow, 2).toString();
        }
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        List<Student> dataHasil;
        if (selectedName.isEmpty()) {
            dataHasil = studentDAO.getStudent();
        } else {
            dataHasil = studentDAO.searchStudent(selectedName);
        }
        DefaultTableModel model = (DefaultTableModel) jTableStudent.getModel();

        model.setRowCount(0);
        for (Student s : dataHasil) {
